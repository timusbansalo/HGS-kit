...
void grain_bandpass_subtractive_ST(VectorBrushMessage* vbm, BrushStateRec* bsr)
{
...
void grain_bandpass_subtractive_ST(VectorBrushMessage* vbm, BrushStateRec* bsr, int numruns)
{
	for (int i = 0; i < numruns; i++)
	{
		for (int y = 0 /*CPR.top*/; y < 512 /*CPR.bottom*/; y++)
		{
			...
			grain_bandpass_subtractive_ST(vbm, bsr);
		}
	}
}